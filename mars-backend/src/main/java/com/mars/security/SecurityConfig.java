    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/scheduler-status", "/admin/scheduler-status/**").hasRole("ADMIN")
                        ...
                        .requestMatchers("/academician/appointments", "/academician/appointments/**")
                                .hasRole("ACADEMICIAN")
                        .requestMatchers(HttpMethod.GET, "/academician/dashboard")
                                .hasRole("ACADEMICIAN")
                        .requestMatchers(
                                HttpMethod.GET,
                                "/assistant/courses",
                                "/assistant/dashboard")
                                .hasRole("ASSISTANT")
                        .requestMatchers(HttpMethod.GET, "/students/appointments", "/students/appointments/**")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/students/appointments").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.PATCH, "/students/appointments/**").hasRole("STUDENT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/students/academicians", "/students/academicians/**")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/students/appointment-categories")
                                .hasRole("STUDENT")
                        .requestMatchers("/courses", "/courses/**").hasRole("ACADEMICIAN")
                        .requestMatchers("/course-assignments", "/course-assignments/**")
                                .hasRole("ACADEMICIAN")
                        .requestMatchers("/availability-slots", "/availability-slots/**")
                                .hasAnyRole("ASSISTANT", "ACADEMICIAN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/delegations/student/pending")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/delegations/student/history")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/delegations/*/student-accept", "/delegations/*/student-reject")
                                .hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/delegations/history", "/delegations/sent", "/delegations/received")
                                .hasAnyRole("ACADEMICIAN", "ASSISTANT")
                        .requestMatchers(HttpMethod.GET, "/delegations/*")
                                .hasAnyRole("ACADEMICIAN", "ASSISTANT", "STUDENT")
