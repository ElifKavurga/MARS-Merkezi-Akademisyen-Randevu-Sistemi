...
public final class OutOfOfficePeriodMessages {
    ...
    public static final String INVALID_REASON_CODE = "Geçersiz ofis dışı sebep kodu.";
    public static final String INVALID_DATE_RANGE = "Başlangıç tarihi bitiş tarihinden sonra olamaz.";
    public static final String PAST_DATE = "Geçmiş tarih için ofis dışı dönem oluşturulamaz.";
    ...
    public static final String PAST_PERIOD_NOT_UPDATABLE =
            "Geçmişte tamamen bitmiş ofis dışı dönemler güncellenemez.";
    ...
    public static final String PAST_PERIOD_NOT_ENDABLE =
            "Geçmişte tamamen bitmiş ofis dışı dönemler için işlem yapılamaz.";
