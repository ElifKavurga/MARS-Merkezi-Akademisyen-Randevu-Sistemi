...
public final class RecurrenceRuleMessages {
    ...
    public static final String INVALID_REPEAT_TYPE = "Geçersiz tekrar türü.";
    ...
    public static final String PAST_RULE_NOT_UPDATABLE = "Geçmişte tamamlanmış tekrarlar güncellenemez.";
    ...
    public static final String PAST_RULE_NOT_ENDABLE = "Geçmişte tamamlanmış tekrarlar için işlem yapılamaz.";
