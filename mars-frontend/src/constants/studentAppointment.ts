...
export const STUDENT_APPOINTMENT_MESSAGES = {
  ...
  SUBTITLE: 'Seçtiğiniz personel için randevu talebini adım adım oluşturun.',
  LOADING: 'Personel bilgileri yükleniyor...',
  LOAD_ERROR: 'Personel bilgileri yüklenirken bir hata oluştu.',
  NOT_FOUND: 'Personel bulunamadı',
  NOT_FOUND_DESCRIPTION:
    'Randevu oluşturmak istediğiniz personel bulunamadı veya listede yer almıyor.',
  INVALID_ID: 'Geçerli bir personel kimliği gereklidir.',
  NOT_ACCEPTING_TITLE: 'Yeni randevu kabul edilmiyor',
  NOT_ACCEPTING_DESCRIPTION:
    'Bu personel şu an yeni randevu kabul etmiyor. Lütfen daha sonra tekrar deneyin.',
  ...
  STEP_COURSE_EMPTY_DESCRIPTION:
    'Bu personele ait seçilebilir aktif ders bulunmuyor.',
  ...
  STEP_SLOT_EMPTY_DESCRIPTION: 'Bu personel için uygun randevu saati bulunamadı.',
  ...
  STEP_CONFIRM_ACADEMICIAN: 'Personel',
  STEP_CONFIRM_TITLE_LABEL: 'Ünvan',
  ...
  FILTER_MEETING_TYPE: 'Görüşme Türü',
  FILTER_MEETING_TYPE_ALL: 'Tüm görüşme türleri',
  FILTER_DATE_FROM: 'Başlangıç tarihi',
  FILTER_DATE_TO: 'Bitiş tarihi',
  FILTER_SORT: 'Sıralama',
  FILTER_CLEAR: 'Filtreleri Temizle',
  FILTER_EMPTY_TITLE: 'Sonuç bulunamadı',
  FILTER_EMPTY:
    'Arama veya filtrelere uygun randevu yok. Filtreleri temizleyip tekrar deneyebilirsiniz.',
  SORT_DATE_ASC: 'En Yakın Tarih',
