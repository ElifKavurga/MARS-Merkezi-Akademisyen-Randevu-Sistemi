...
export const STAFF_APPOINTMENT_MESSAGES = {
  ...
  COMPLETE_TITLE: 'Randevuyu Tamamla',
  COMPLETE_DESCRIPTION: 'Bu randevuyu tamamlandı olarak işaretlemek istediğinize emin misiniz?',
  COMPLETE_SUCCESS: 'Randevu tamamlandı olarak işaretlendi.',
  NO_SHOW_TITLE: 'Randevuya Katılmadı Olarak İşaretle',
  NO_SHOW_DESCRIPTION: 'Öğrencinin randevuya katılmadığını onaylıyor musunuz? Bu işlem ceza sistemiyle ilişkilidir.',
  NO_SHOW_SUCCESS: 'Randevu, Randevuya Katılmadı olarak işaretlendi.',
  ...
  ACTION_NOT_APPROVED: 'Randevu artık onaylanmış durumda değil.',
  ...
  TAB_NO_SHOW: 'Randevuya Katılmadı',
  ...
  EMPTY_NO_SHOW: 'Randevuya katılmadı kaydı bulunmuyor.',
