...
export const COURSE_MESSAGES = {
  ...
  ASSISTANTS_ERROR: 'Araştırma görevlisi listesi yüklenemedi. Lütfen tekrar deneyin.',
  ASSISTANTS_EMPTY: 'Bu derse henüz araştırma görevlisi atanmadı.',
  ASSIGN_SUCCESS: 'Araştırma görevlisi derse başarıyla atandı.',
  ASSIGN_ERROR: 'Araştırma görevlisi atanamadı. Lütfen tekrar deneyin.',
  ASSIGNMENT_UPDATE_SUCCESS: 'Araştırma görevlisi ataması başarıyla güncellendi.',
  ASSIGNMENT_UPDATE_ERROR: 'Araştırma görevlisi ataması güncellenemedi. Lütfen tekrar deneyin.',
  ASSIGNMENT_REMOVE_SUCCESS: 'Araştırma görevlisi ataması başarıyla kaldırıldı.',
  ASSIGNMENT_REMOVE_ERROR: 'Araştırma görevlisi ataması kaldırılamadı. Lütfen tekrar deneyin.',
  ASSIGNMENT_REMOVE_TITLE: 'Araştırma Görevlisi Atamasını Kaldır',
  ASSIGNMENT_REMOVE_DESCRIPTION: 'Bu araştırma görevlisini dersten kaldırmak istediğinize emin misiniz?',
  ...
  SECTION_ASSISTANTS: 'Araştırma Görevlileri',
  ...
  STAT_ASSISTANTS: 'Toplam Araştırma Görevlisi Sayısı',
